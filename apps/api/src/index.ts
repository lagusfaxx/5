...
import { applyDbHotfixes } from "./dbHotfix";
...
async function boot() {
  // Safety net for drifted DBs (e.g. missing Category.kind even when migrations look applied)
  await applyDbHotfixes().catch((err) => console.error("[db] hotfix failed", err));
